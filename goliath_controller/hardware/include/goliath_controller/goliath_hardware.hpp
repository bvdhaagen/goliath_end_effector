...
public:
  ...
  return_type write(const rclcpp::Time &, const rclcpp::Duration &) override;
    ...
    void sendHomingCommand() {
        const char homing_cmd = 'H';  
        boost::asio::write(*serial_port_, boost::asio::buffer(&homing_cmd, 1));
        RCLCPP_INFO(rclcpp::get_logger("RobotSystem"), "Sent homing command");
    }
...
private:
  ...
  // Configuration
  std::atomic<bool> homing_complete_;  // Atomic for thread-safe access
